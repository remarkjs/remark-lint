...
* [Use](#use)
* [API](#api)
  * [`unified().use(remarkLintNoUnusedDefinitions)`](#unifieduseremarklintnounuseddefinitions)
...
[`remarkLintNoUnusedDefinitions`][api-remark-lint-no-unused-definitions].
...
[badge-downloads-image]: https://img.shields.io/npm/dm/remark-lint-no-unused-definitions.svg

[badge-downloads-url]: https://www.npmjs.com/package/remark-lint-no-unused-definitions
...
[badge-size-image]: https://img.shields.io/bundlejs/size/remark-lint-no-unused-definitions

[badge-size-url]: https://bundlejs.com/?q=remark-lint-no-unused-definitions
